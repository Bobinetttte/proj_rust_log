...
impl Stats {
    ...
    pub fn calculate_stats(&mut self, event : &Event) {
        ...
        // if event.gravity_level > self.worse_gravity {
        //     self.worse_gravity = event.gravity_level;
        // }

    }

    pub fn get_stats(&self) -> (u128, u128, u128, u128/*, Gravity*/) {
        return (self.nb_events_total, self.nb_events_warning, self.nb_events_error, self.nb_events_critical/*, self.worse_gravity*/);
    }
}
